  ...
  const faqs = [
    {
      ...
      a: "We accept all standard audio and video formats including MP3, MP4, WAV, AVI, MOV, and more. You can also share secure cloud links via Google Drive or Dropbox."
    },
    {
      q: "Do you offer time-stamped transcriptions?",
      a: "Yes, we provide time-stamping at regular intervals or per speaker change to help you navigate long recordings easily."
    },
    {
      q: "Can I request verbatim transcription?",
      a: "Absolutely. We offer both clean verbatim (removing stutters) and full verbatim (capturing every utterance) for legal or academic research."
    },
    {
      q: "Is your transcription service certified for legal or official use?",
      a: "Yes. Our transcripts are handled by certified linguists and can be officially stamped for use in UAE courts and government departments."
    },
    {
      q: "How quickly can you deliver a transcript?",
      a: "Standard delivery is 24-48 hours. We also offer express services for urgent business meetings with a turnaround as fast as 6 hours."
    }
  ];
  ...
  const features = [
    {
      ...
      text: "Certified language experts with native-speaking transcription specialists across multiple industries.",
      icon: <Mic size={26} />
    },
    {
      title: "50+ Languages",
      text: "Multi-language support including Arabic, English, French, Spanish, Hindi, Urdu, Russian and more.",
      icon: <Languages size={26} />
    },
    {
      title: "Industry Specific",
      text: "Specialized industry transcription for legal hearings, academic research, and corporate meetings.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:items-start">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold text-slate-900 leading-tight mb-8">
              Multilingual <span className="text-[#2b9cb3]">Business Translation</span> in Dubai
            </h1>

            <div className="space-y-6 text-slate-600 text-base md:text-lg leading-relaxed max-w-3xl">
              <p>
                In today’s fast-paced, globalized world, converting audio and
                video content into accurate written text across multiple
              ...
              <div className="bg-white border-l-4 border-[#2b9cb3] p-6 rounded-r-2xl shadow-sm my-8 border border-slate-100">
                <p className="italic text-slate-700 font-medium leading-relaxed">
                  "Whether it’s interviews, webinars, or court recordings, our 
                  expert linguists deliver precise and culturally sensitive 
                  transcriptions across 50+ languages."
                </p>
              </div>

              <p>
                Each transcript preserves tone, context, and technical
                terminology while ensuring confidentiality and certified quality 
          ...
          >
            <div className="bg-slate-900 rounded-3xl p-8 shadow-2xl relative overflow-hidden text-white">
              ...
              <p className="text-slate-400 mb-8 relative z-10 text-sm leading-relaxed">
                Need professional transcription or business translation? Contact us for a free quote.
              </p>
        ...
        <div className="mt-24 max-w-4xl mb-14">
          <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900">Service FAQ</h2>
          </div>
