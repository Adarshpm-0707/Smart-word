  ...
  const faqs = [
    {
      ...
      a: "A board resolution is a formal document recording decisions made by a company’s board of directors. It is required for official actions like appointing directors, opening bank accounts, authorizing major transactions, or changing company legal structures.",
    },
    {
      q: "Does a board resolution need to be notarized in Dubai?",
      a: "Yes, most government entities (DED/DET), banks, and free zone authorities require board resolutions to be notarized by a UAE Public Notary to ensure they are legally binding and officially recognized.",
    },
    {
      q: "Can you assist with drafting the board resolution?",
      a: "Absolutely. Our legal team drafts resolutions that are fully compliant with the UAE Commercial Companies Law, ensuring the phrasing and format meet the strict requirements of the Dubai Notary Public.",
    },
    {
      q: "Is Arabic translation required for notarizing a board resolution?",
      a: "Yes. For any board resolution to be notarized in the UAE, it must be presented in Arabic or a bilingual (English-Arabic) format. We provide certified legal translation as part of our notarization service.",
    },
  ];
  ...
  const features = [
    {
      ...
      text: "Drafting aligned with UAE commercial law to reflect your company’s structure and governance policies.",
      icon: <Scale className="text-[#2b9cb3]" size={24} />
    },
    {
      title: "Certified Translation",
      text: "Certified Arabic translations to ensure your board resolution is legally acceptable by the Notary Public.",
      icon: <Languages className="text-[#2b9cb3]" size={24} />
    },
    {
      title: "Fast Turnaround",
      text: "Expert handling for urgent corporate approvals, allowing you to proceed with licensing or banking changes.",
      icon: <Zap className="text-[#2b9cb3]" size={24} />
    },
    {
      title: "Notary Public Coordination",
      text: "Full management of the process, from appointment scheduling to assisting at the notary office.",
      icon: <Building2 className="text-[#2b9cb3]" size={24} />
    },
    {
      title: "Authority Approved",
      text: "Resolutions accepted by all UAE authorities including banks, DED, courts, and free zones.",
      icon: <ShieldCheck className="text-[#2b9cb3]" size={24} />
    },
    {
      title: "Document Integrity",
      text: "Highest standards of security and confidentiality for your sensitive corporate documents.",
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:items-start">
          ...
          >
            ...
            <div className="space-y-6 text-slate-600 text-base md:text-lg leading-relaxed max-w-3xl">
              <p>
                ...
                board of directors to authorize specific actions or strategic 
                changes. In the UAE, these must often be notarized to be 
                recognized by banks and government departments.
              </p>
              
              <div className="bg-white border-l-4 border-[#2b9cb3] p-6 rounded-r-2xl shadow-sm my-8">
                <p className="italic text-slate-700 font-medium">
                  "At Smart Word, we manage the entire notarization cycle—from 
                  bilingual drafting and certified translation to coordination 
                  with the Dubai Notary Public—ensuring your resolutions are legally valid."
                </p>
              </div>

              <p>
                Whether you are amending company activities or authorizing a legal 
                representative, our team ensures your corporate records are 
                accurately prepared and fully compliant with UAE legal standards.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-slate-900 rounded-3xl p-8 shadow-2xl relative overflow-hidden text-white">
              ...
              <h3 className="text-2xl font-bold mb-4 relative z-10">Authorize Now</h3>
              <p className="text-slate-400 mb-8 relative z-10 text-sm leading-relaxed">
                Need official corporate approvals for a bank or DED? Our specialists ensure your resolutions are notarized without delay.
              </p>
        ...
        >
          <div className="relative z-10">
            <h2 className="text-3xl font-bold mb-4">
              Need Reliable Corporate Legal Services?
            </h2>
            <p className="mb-8 text-white/90 max-w-2xl mx-auto text-lg">
              Our specialists ensure your board resolutions are authenticated 
              correctly so your company operations can proceed without delays.
            </p>
            <Link
              to="/contact"
